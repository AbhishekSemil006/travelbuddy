...
const Auth = () => {
    ...
    try {
      if (mode === 'forgot') {
        ...
        if (result.needsEmailConfirmation) {
          ...
          // Session is already active — navigate to home / onboarding
  ...
  const handleGoogleSignIn = async () => {
    toast.error('Google sign-in is not yet supported in the new backend');
  };
    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-2">
      ...
      >
        ...
        <div className=" text-center">
          ...
          >
            <img src="/logo.png" alt="TravelBuddy Logo" className="h-[250px]" />
          </motion.div>
