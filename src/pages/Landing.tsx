    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="border-t bg-secondary/30 py-16 sm:py-24">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          >
            <span className="inline-flex items-center gap-1.5 text-sm font-bold text-primary uppercase tracking-widest mb-3">
              <Heart className="h-4 w-4" /> Meet the Team
            </span>
          ...
          <div className="grid gap-8 sm:grid-cols-2 max-w-3xl mx-auto">
            ...
            <motion.div
              ...
              transition={{ delay: 0 }}
            >
              <div className="group relative w-full overflow-hidden rounded-3xl border bg-card p-8 text-center shadow-sm transition-all duration-300 hover:shadow-xl sm:p-10 h-full">
                ...
                <div className="relative z-10 flex flex-col items-center">
                  ...
                  <div className="flex justify-center gap-4">
                    ...
                    <a
                      href="mailto:abhisheksemil700@gmail.com"
                      className="flex h-11 w-11 items-center justify-center rounded-full bg-muted text-muted-foreground transition-all hover:bg-primary/10 hover:text-primary hover:scale-110"
                      aria-label="Email"
                    >
            ...
            >
              <div className="group relative w-full overflow-hidden rounded-3xl border bg-card p-8 text-center shadow-sm transition-all duration-300 hover:shadow-xl sm:p-10 h-full">
                <div className="absolute inset-0 bg-gradient-to-br from-violet-500/5 via-transparent to-sky-500/5 opacity-0 group-hover:opacity-100 transition-opacity" />
                <div className="relative z-10 flex flex-col items-center">
                  <div className="mb-5 flex h-24 w-24 items-center justify-center rounded-full border-4 border-background bg-gradient-to-br from-violet-400/20 to-sky-400/20 shadow-lg">
                    <span className="font-display text-4xl font-bold bg-gradient-to-br from-violet-500 to-sky-500 bg-clip-text text-transparent">RG</span>
                  </div>
                  <h3 className="mb-1 font-display text-2xl font-bold text-foreground">
                    Rishav Kumar Garg
                  </h3>
                  <p className="mb-4 text-sm font-semibold bg-gradient-to-r from-violet-500 to-sky-500 bg-clip-text text-transparent">
                    Full Stack Developer
                  </p>
                  <p className="mb-8 flex items-center justify-center gap-1.5 text-sm text-muted-foreground">
                    Crafted with <Heart className="h-4 w-4 fill-violet-500 text-violet-500" /> for travelers
                  </p>
                  <div className="flex justify-center gap-4">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex h-11 w-11 items-center justify-center rounded-full bg-muted text-muted-foreground transition-all hover:bg-violet-500/10 hover:text-violet-500 hover:scale-110"
                      aria-label="GitHub"
                    >
                      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path fillRule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z" clipRule="evenodd" /></svg>
                    </a>
